...
![Última actualización](https://img.shields.io/badge/actualizado-hoy-green)
...
* Eliminar registros
* Base de datos automática mediante SQLite
...
```
📁 proyecto_final
├── proyecto_final.py        # Programa principal (menú interactivo)
├── modulo_sql.py            # Módulo encargado de manejar la BD
...
Finalizado para entrega en el programa **TALENTO TECH**.
